...
if (NOT "" STREQUAL "")
  set(TEST_EXE_PATH /$<TARGET_FILE_NAME:cutlass_test_unit_gemm_device_grouped_blas3>)
else()
  set(TEST_EXE_PATH $<TARGET_FILE_NAME:cutlass_test_unit_gemm_device_grouped_blas3>)
endif()
...
if (NOT "./bin" STREQUAL "")
  set_tests_properties("ctest_unit_gemm_device_grouped_blas3" PROPERTIES WORKING_DIRECTORY "./bin")
endif()
