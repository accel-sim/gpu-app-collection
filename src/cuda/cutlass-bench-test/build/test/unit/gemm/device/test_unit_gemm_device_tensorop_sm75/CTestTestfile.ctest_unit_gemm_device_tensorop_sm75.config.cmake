...
if (NOT "" STREQUAL "")
  set(TEST_EXE_PATH /$<TARGET_FILE_NAME:cutlass_test_unit_gemm_device_tensorop_sm75>)
else()
  set(TEST_EXE_PATH $<TARGET_FILE_NAME:cutlass_test_unit_gemm_device_tensorop_sm75>)
endif()
...
set_tests_properties(ctest_unit_gemm_device_tensorop_sm75 PROPERTIES DISABLED OFF)
