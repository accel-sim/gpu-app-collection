...
if (NOT "" STREQUAL "")
  set(TEST_EXE_PATH /$<TARGET_FILE_NAME:41_fused_multi_head_attention_backward>)
else()
  set(TEST_EXE_PATH $<TARGET_FILE_NAME:41_fused_multi_head_attention_backward>)
endif()
...
if (NOT "./bin" STREQUAL "")
  set_tests_properties("ctest_examples_41_fused_multi_head_attention_backward" PROPERTIES WORKING_DIRECTORY "./bin")
endif()
