...
if (NOT "" STREQUAL "")
  set(TEST_EXE_PATH /$<TARGET_FILE_NAME:13_fused_two_gemms_s8_sm75_shmem>)
else()
  set(TEST_EXE_PATH $<TARGET_FILE_NAME:13_fused_two_gemms_s8_sm75_shmem>)
endif()
...
if (NOT "./bin" STREQUAL "")
  set_tests_properties("ctest_examples_13_fused_two_gemms_s8_sm75_shmem" PROPERTIES WORKING_DIRECTORY "./bin")
endif()
